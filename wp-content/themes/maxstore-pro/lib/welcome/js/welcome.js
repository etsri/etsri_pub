jQuery(document).ready(function() {
  ...
  if ( counter != '0')  {  
	...
	function maxstore_pro_welcome_page_tabs(event) {
	...
	var maxstore_pro_actions_anchor = location.hash;

	if( (typeof maxstore_pro_actions_anchor !== 'undefined') && (maxstore_pro_actions_anchor != '') ) {
		maxstore_pro_welcome_page_tabs('a[href="'+ maxstore_pro_actions_anchor +'"]');
	}

    jQuery(".maxstore-nav-tabs a").click(function(event) {
        event.preventDefault();
		maxstore_pro_welcome_page_tabs(this);
    });
