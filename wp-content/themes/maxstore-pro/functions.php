...
add_action( 'after_setup_theme', 'maxstore_pro_setup' );

if ( !function_exists( 'maxstore_pro_setup' ) ) :

	function maxstore_pro_setup() {
		// Theme lang
		...
		array(
			...
			'footer_menu'	 => __( 'Footer Menu', 'maxstore' ),
		)
		);

		add_theme_support( 'post-thumbnails' );
		set_post_thumbnail_size( 300, 300, true );
		add_image_size( 'maxstore-recent', 640, 280, true );
		...
		add_image_size( 'maxstore-widget', 60, 60, true );
		add_image_size( 'maxstore-carousel', 260, 332, true );
...
////////////////////////////////////////////////////////////////////
function maxstore_pro_theme_stylesheets() {
	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/css/bootstrap.css', array(), '3.3.4', 'all' );
	wp_enqueue_style( 'maxstore-stylesheet', get_stylesheet_uri(), array(), '2.1.4', 'all' );
...
add_action( 'wp_enqueue_scripts', 'maxstore_pro_theme_stylesheets' );
...
////////////////////////////////////////////////////////////////////
function maxstore_pro_theme_js() {
	wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/js/bootstrap.js', array( 'jquery' ), '3.3.4' );
	wp_enqueue_script( 'maxstore-theme-js', get_template_directory_uri() . '/js/customscript.js', array( 'jquery' ), '1.9.5' );
	...
	if ( get_theme_mod( 'menu-sticky', 0 ) != 0 && has_nav_menu( 'main_menu' ) ) {
		wp_enqueue_script( 'menu-sticky', get_template_directory_uri() . '/js/sticky-menu.js', array( 'jquery' ), '1' );
	}
	wp_enqueue_script( 'maxstore-store-countdown', get_template_directory_uri() . '/js/countdown.min.js', array( 'jquery' ), '1', true );
}

add_action( 'wp_enqueue_scripts', 'maxstore_pro_theme_js' );
...
add_action( 'widgets_init', 'maxstore_pro_widgets_init' );

function maxstore_pro_widgets_init() {
	register_sidebar(
	array(
		'name'			 => __( 'Homepage Sidebar', 'maxstore' ),
		'id'			 => 'maxstore-home-sidebar',
	...
	register_sidebar(
	array(
		'name'			 => __( 'Top Bar Section', 'maxstore' ),
		'id'			 => 'maxstore-topbar-area',
		'description'	 => __( 'Top Bar section for language or currency switcher. Use carefully!', 'maxstore' ),
	...
	register_widget( 'maxstore_pro_posts_widget' );
...
add_action( 'maxstore_pro_main_content_width_hook', 'maxstore_pro_main_content_width_columns' );

function maxstore_pro_main_content_width_columns() {
...
function maxstore_pro_main_content_width() {
	do_action( 'maxstore_pro_main_content_width_hook' );
}
...
function maxstore_pro_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'maxstore_pro_content_width', 800 );
}
add_action( 'after_setup_theme', 'maxstore_pro_content_width', 0 );

////////////////////////////////////////////////////////////////////
// Schema.org microdata
////////////////////////////////////////////////////////////////////
function maxstore_pro_tag_schema() {
...
// Breadcrumbs
////////////////////////////////////////////////////////////////////
	function maxstore_pro_breadcrumb() {
		...
		if ( is_home() || is_front_page() ) {
			...
			if ( 'page' == get_option( 'show_on_front' ) && get_option( 'page_for_posts' ) ) {
				echo '<span itemscope itemtype="' . esc_url( $schema_link ) . '"><a itemprop="url" href="' . esc_url( get_permalink( get_option( 'page_for_posts' ) ) ) . '">' . '<span itemprop="title">' . esc_html__( 'Blog', 'maxstore' ) . '</span></a></span>' . $delimiter . ' ';
			}
...
// Social links
////////////////////////////////////////////////////////////////////
if ( !function_exists( 'maxstore_pro_social_links' ) ) :
	 ...
	 */
	function maxstore_pro_social_links() {
...
////////////////////////////////////////////////////////////////////
	add_filter( 'loop_shop_columns', 'maxstore_pro_loop_columns' );
	if ( !function_exists( 'maxstore_pro_loop_columns' ) ) {

		function maxstore_pro_loop_columns() {
...
////////////////////////////////////////////////////////////////////  
	...
	add_action( 'woocommerce_before_shop_loop_item', 'maxstore_pro_wishlist_products', 9 );

////////////////////////////////////////////////////////////////////
// Secondary image hover function
////////////////////////////////////////////////////////////////////  
	if ( get_theme_mod( 'woo_second_img', 0 ) != 0 ) {
		add_action( 'woocommerce_before_shop_loop_item_title', 'maxstore_pro_woocommerce_template_loop_second_product_thumbnail', 11 );
		add_filter( 'post_class', 'maxstore_pro_product_has_gallery' );

		// Add maxstore-has-gallery class to products that have a gallery
		function maxstore_pro_product_has_gallery( $classes ) {
			global $product;
		...
		function maxstore_pro_woocommerce_template_loop_second_product_thumbnail() {
	...
	function maxstore_pro_woocommerce_breadcrumbs() {
		return array(
				'delimiter'   => ' &raquo; ',
	...
	add_filter( 'woocommerce_breadcrumb_defaults', 'maxstore_pro_woocommerce_breadcrumbs' );
}
////////////////////////////////////////////////////////////////////
// WooCommerce end
////////////////////////////////////////////////////////////////////
