...
<div class="row rsrc-content">    
	...
	<article class="col-md-<?php maxstore_pro_main_content_width(); ?> rsrc-main" itemscope itemtype="http://schema.org/BlogPosting">        
		<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>         
				...
				<div <?php post_class( 'rsrc-post-content' ); ?>>                            
					...
					<?php wp_link_pages(); ?>
					<?php get_template_part( 'templates/template-part', 'posttags' ); ?>                              
					...
					<?php get_template_part( 'templates/template-part', 'related' ); ?>                             
					<?php get_template_part( 'templates/template-part', 'postauthor' ); ?>                             
