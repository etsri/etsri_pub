...
function tabs(evt, tab) {
	if(!jQuery(evt).hasClass("active")) {
		jQuery(evt).addClass("active");
	}else{
		jQuery(evt).removeClass("active");
	}
	if(tab=='General'){
		jQuery("#General").show();
		jQuery("#Invoice").hide();
		jQuery("#invoice_tab").removeClass("active");
		jQuery("#Email").hide();
		jQuery("#email_tab").removeClass("active");						
	}else if(tab=='Invoice'){
		jQuery("#Invoice").show();
		jQuery("#General").hide();
		jQuery("#general_tab").removeClass("active");
		jQuery("#Email").hide();
		jQuery("#email_tab").removeClass("active");
	} else if (tab=='Email'){
		jQuery("#Email").show();
